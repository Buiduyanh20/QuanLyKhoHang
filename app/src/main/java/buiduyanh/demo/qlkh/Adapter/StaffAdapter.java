package buiduyanh.demo.qlkh.Adapter;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (resource == R.layout.item_staff_request) {
            holder.imgAccept.setOnClickListener(view -> {
                ...
                RequestActivity.adapter = new StaffAdapter(context, R.layout.item_staff_request, RequestActivity.list);
                RequestActivity.binding.lv.setAdapter(RequestActivity.adapter);
            });
